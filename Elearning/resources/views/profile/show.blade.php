...
<head>
    ...
    <style>
        * {
        ...
        .profile-card, .info-card, .actions-card {
            background: white;
            border-radius: 15px;
            padding: 30px;
        ...
        .profile-card:hover, .info-card:hover, .actions-card:hover {
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('profile.password') }}" method="POST">
                ...
                <div class="modal-buttons">
                    <button type="button" class="action-btn btn-secondary" onclick="closeModal('passwordModal')">Batal</button>
    ...
    <div id="deleteModal" class="modal">
        <div class="modal-content">
            ...
            <form action="{{ route('profile.destroy') }}" method="POST">
                ...
                <div class="modal-buttons">
                    <button type="button" class="action-btn btn-secondary" onclick="closeModal('deleteModal')">Batal</button>
